...
st.sidebar.markdown(
    """Here you can generate your quiz, made of multiple choice and true/false questions. 
...
def main():
    ...
    with col2:  # With second column
        if n_mcq > 0:
            n_mcq_options = st.number_input(
                "How many options in a question?",
                value=2,
                step=1,
                min_value=2,
                max_value=7,
    ...
    if uploaded_file is not None:
        ...
        try:
            ...
            st.error("No credentials provided. Please configure your AWS credentials.")
